...
class NotificationService {
  ...
  static void _scheduleExpiryCheck() async {
    ...
    // But for demonstration, we'll show how to check for expiring policies
  ...
  static void _navigateBasedOnNotificationType(Map<String, dynamic> data) {
    ...
    // For demonstration, we'll just print the navigation intent
    ...
    switch (type) {
      case 'insurance_status':
        ...
        // Example: NavigationService.navigateTo('/insurance_details', arguments: data);
        break;
      case 'claim_status':
        print('Navigate to claim details for claim: ${data['claimId']}');
        // Example: NavigationService.navigateTo('/claim_details', arguments: data);
        break;
      case 'expiry_reminder':
        print(
          'Navigate to insurance renewal for vehicle: ${data['vehicleReg']}',
        );
        // Example: NavigationService.navigateTo('/insurance_renewal', arguments: data);
        break;
      case 'offers':
        print('Navigate to insurance offers for request: ${data['requestId']}');
        // Example: NavigationService.navigateTo('/insurance_offers', arguments: data);
        break;
      case 'approval':
        print('Navigate to payment for request: ${data['requestId']}');
        // Example: NavigationService.navigateTo('/payment', arguments: data);
        break;
      case 'rejection':
        print('Navigate to insurance history');
        // Example: NavigationService.navigateTo('/insurance_history');
        break;
      case 'payment':
        print('Navigate to policy details for request: ${data['requestId']}');
        // Example: NavigationService.navigateTo('/policy_details', arguments: data);
        break;
      default:
