...
class _InsuranceRequestPageState extends State<InsuranceRequestPage> {
  ...
  void _calculateCurrentValue() {
    ...
    double calculatedAmount = currentValue * 0.05; // Base insurance is 5% of current value
  ...
  void _proceedToPayment() {
    if (_existingRequestId == null || _selectedOfferType == null || _selectedOfferAmount == null) {
      return;
    }
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Text(
                            ...
                            style: TextStyle(
                              fontWeight: FontWeight.bold,
                              color: _hadAccident ? AppTheme.warningOrange : null,
                            ),
                          ),
                        ],
                      ),
